...
public class Football04 {
    public static void main(String[] args) {
        ...
        System.out.println("Several clubs have 49 points:");
        table.stream().filter(club -> club.getPoints() == 49)
                .forEach(System.out::println);

        System.out.println("\nClubs with 48 points:");
        table.stream().filter(club -> club.getPoints() == 48)
                .forEach(System.out::println);
        ...
        System.out.println("Several clubs have 49 points:");
        table.parallelStream().filter(club -> club.getPoints() == 49)
                .forEach(System.out::println);

        System.out.println("\nClubs with 48 points:");
        table.parallelStream().filter(club -> club.getPoints() == 48)
                .forEach(System.out::println);
